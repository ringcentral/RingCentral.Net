...
namespace RingCentral.Paths.Restapi.Account.Extension.Presence
{
    public partial class Index
    {
        ...
        /// </summary>
        public async Task<RingCentral.PresenceInfoResponse> Get(RingCentral.ReadUserPresenceStatusParameters queryParams = null, RestRequestConfig restRequestConfig = null)
        {
            return await rc.Get<RingCentral.PresenceInfoResponse>(this.Path(), queryParams, restRequestConfig);
        }
        ...
        /// </summary>
        public async Task<RingCentral.PresenceInfoResponse> Put(RingCentral.PresenceInfoRequest presenceInfoRequest, RestRequestConfig restRequestConfig = null)
        {
            return await rc.Put<RingCentral.PresenceInfoResponse>(this.Path(), presenceInfoRequest, null, restRequestConfig);
        }
    }
}
