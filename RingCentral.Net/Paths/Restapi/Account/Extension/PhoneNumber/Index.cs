...
namespace RingCentral.Paths.Restapi.Account.Extension.PhoneNumber
{
    public partial class Index
    {
        ...
        /// </summary>
        public async Task<RingCentral.GetExtensionPhoneNumbersResponse> Get(RingCentral.ListExtensionPhoneNumbersParameters queryParams = null, RestRequestConfig restRequestConfig = null)
        {
            return await rc.Get<RingCentral.GetExtensionPhoneNumbersResponse>(this.Path(), queryParams, restRequestConfig);
        }
    }
}
