...
namespace RingCentral.Paths.Restapi.Account.Extension.Favorite
{
    public partial class Index
    {
        ...
        /// </summary>
        public async Task<RingCentral.FavoriteContactList> Put(RingCentral.FavoriteCollection favoriteCollection, RestRequestConfig restRequestConfig = null)
        {
            return await rc.Put<RingCentral.FavoriteContactList>(this.Path(), favoriteCollection, null, restRequestConfig);
        }
    }
}
