...
/// 
        ...
        /// </summary>
  public async Task<RingCentral.WirelessPointsList> List(RingCentral.ListWirelessPointsParameters queryParams = null, RestRequestConfig restRequestConfig = null)
  {
...
/// 
        ...
        /// User Permission: ConfigureEmergencyMaps
        /// </summary>
  public async Task<RingCentral.WirelessPointInfo> Post(RingCentral.CreateWirelessPoint createWirelessPoint, RestRequestConfig restRequestConfig = null)
  {
return await rc.Post<RingCentral.WirelessPointInfo>(this.Path(false), createWirelessPoint, null, restRequestConfig);
  }
...
/// 
        ...
        /// User Permission: ConfigureEmergencyMaps
        /// </summary>
  public async Task<RingCentral.WirelessPointInfo> Put(RingCentral.UpdateWirelessPoint updateWirelessPoint, RestRequestConfig restRequestConfig = null)
  {
if (pointId == null)
    {
        throw new System.ArgumentException("Parameter cannot be null", nameof(pointId));
    }return await rc.Put<RingCentral.WirelessPointInfo>(this.Path(), updateWirelessPoint, null, restRequestConfig);
  }
