...
/// 
        ...
        /// </summary>
  public async Task<RingCentral.UpdateMultipleWirelessPointsResponse> Post(RingCentral.UpdateMultipleWirelessPointsRequest updateMultipleWirelessPointsRequest, RestRequestConfig restRequestConfig = null)
  {
return await rc.Post<RingCentral.UpdateMultipleWirelessPointsResponse>(this.Path(), updateMultipleWirelessPointsRequest, null, restRequestConfig);
  }
    }
}
