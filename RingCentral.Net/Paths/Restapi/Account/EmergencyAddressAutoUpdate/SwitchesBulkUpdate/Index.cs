...
namespace RingCentral.Paths.Restapi.Account.EmergencyAddressAutoUpdate.SwitchesBulkUpdate
{
    public partial class Index
    {
        ...
        /// </summary>
        public async Task<RingCentral.UpdateMultipleSwitchesResponse> Post(RingCentral.UpdateMultipleSwitchesRequest updateMultipleSwitchesRequest, RestRequestConfig restRequestConfig = null)
        {
            return await rc.Post<RingCentral.UpdateMultipleSwitchesResponse>(this.Path(), updateMultipleSwitchesRequest, null, restRequestConfig);
        }
    }
}
