...
namespace RingCentral.Paths.Restapi.Account.EmergencyAddressAutoUpdate.WirelessPointsBulkCreate
{
    public partial class Index
    {
        ...
        /// </summary>
        public async Task<RingCentral.CreateMultipleWirelessPointsResponse> Post(RingCentral.CreateMultipleWirelessPointsRequest createMultipleWirelessPointsRequest, RestRequestConfig restRequestConfig = null)
        {
            return await rc.Post<RingCentral.CreateMultipleWirelessPointsResponse>(this.Path(), createMultipleWirelessPointsRequest, null, restRequestConfig);
        }
    }
}
