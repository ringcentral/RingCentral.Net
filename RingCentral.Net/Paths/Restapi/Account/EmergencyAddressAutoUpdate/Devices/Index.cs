...
namespace RingCentral.Paths.Restapi.Account.EmergencyAddressAutoUpdate.Devices
{
    public partial class Index
    {
        ...
        /// </summary>
        public async Task<RingCentral.ListDevicesAutomaticLocationUpdates> Get(RingCentral.ListDevicesAutomaticLocationUpdatesParameters queryParams = null, RestRequestConfig restRequestConfig = null)
        {
            return await rc.Get<RingCentral.ListDevicesAutomaticLocationUpdates>(this.Path(), queryParams, restRequestConfig);
        }
    }
}
