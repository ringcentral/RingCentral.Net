...
namespace RingCentral.Paths.Restapi.Account.Telephony.Sessions.Parties.Forward
{
    public partial class Index
    {
        ...
        /// </summary>
        public async Task<RingCentral.ForwardCallPartyResponse> Post(RingCentral.ForwardTarget forwardTarget, RestRequestConfig restRequestConfig = null)
        {
            return await rc.Post<RingCentral.ForwardCallPartyResponse>(this.Path(), forwardTarget, null, restRequestConfig);
        }
    }
}
