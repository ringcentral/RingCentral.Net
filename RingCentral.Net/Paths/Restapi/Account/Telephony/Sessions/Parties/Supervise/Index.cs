...
/// 
        ...
        /// </summary>
  public async Task<RingCentral.PartySuperviseResponse> Post(RingCentral.PartySuperviseRequest partySuperviseRequest, RestRequestConfig restRequestConfig = null)
  {
return await rc.Post<RingCentral.PartySuperviseResponse>(this.Path(), partySuperviseRequest, null, restRequestConfig);
  }
    }
}
