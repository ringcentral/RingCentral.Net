...
namespace RingCentral.Paths.Restapi.Account.ExtensionBulkUpdate
{
    public partial class Index
    {
        ...
        /// </summary>
        public async Task<RingCentral.ExtensionBulkUpdateTaskResource> Post(RingCentral.ExtensionBulkUpdateRequest extensionBulkUpdateRequest, RestRequestConfig restRequestConfig = null)
        {
            return await rc.Post<RingCentral.ExtensionBulkUpdateTaskResource>(this.Path(), extensionBulkUpdateRequest, null, restRequestConfig);
        }
    }
}
