...
namespace RingCentral.Paths.Restapi.Account.UserRole
{
    public partial class Index
    {
        ...
        public async Task<RingCentral.RolesCollectionResource> List(
            RingCentral.ListUserRolesParameters queryParams = null, RestRequestConfig restRequestConfig = null)
        {
        ...
        /// </summary>
        public async Task<string> Post(RingCentral.RoleResource roleResource,
        ...
        /// User Permission: EditUserRoles
        /// </summary>
        public async Task<string> Delete(RingCentral.DeleteCustomRoleParameters queryParams = null,
            RestRequestConfig restRequestConfig = null)
        {
            if (roleId == null)
            {
