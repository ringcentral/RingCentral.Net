...
public Restapi.V2.Accounts.Extensions.Devices.Index parent;
public Index(Restapi.V2.Accounts.Extensions.Devices.Index parent)
      {
this.parent = parent;
this.rc = parent.rc;
}
...
/// 
        ...
        /// </summary>
  public async Task<string> Post(RingCentral.SwapDeviceRequest swapDeviceRequest, RestRequestConfig restRequestConfig = null)
  {
return await rc.Post<string>(this.Path(), swapDeviceRequest, null, restRequestConfig);
  }
    }
}
...
namespace RingCentral.Paths.Restapi.V2.Accounts.Extensions.Devices
{
    public partial class Index
    {
        public Restapi.V2.Accounts.Extensions.Devices.Replace.Index Replace()
        {
            return new Restapi.V2.Accounts.Extensions.Devices.Replace.Index(this);
        }
    }
}