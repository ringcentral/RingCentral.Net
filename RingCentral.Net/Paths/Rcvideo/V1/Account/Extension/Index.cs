...
public Index(Rcvideo.V1.Account.Index parent, string extensionId = null)
      {
this.parent = parent;
this.rc = parent.rc;
...
namespace RingCentral.Paths.Rcvideo.V1.Account
{
    public partial class Index
    {
        public Rcvideo.V1.Account.Extension.Index Extension(string extensionId = null)
        {
            return new Rcvideo.V1.Account.Extension.Index(this, extensionId);
        }
    }
}