namespace RingCentral
{
    ...
    {
        /// <summary>
        ///     Shipping status of the order item. It is set to 'Initial' when the order is submitted. Then it is changed to
        ///     'Accepted' when a distributor starts processing the order. Finally the status is changed to 'Shipped' which means
        ///     that distributor shipped the device.
