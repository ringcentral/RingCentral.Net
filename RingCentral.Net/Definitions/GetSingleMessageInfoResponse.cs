...
{
    public class GetSingleMessageInfoResponse
    {
        /// <summary>
        ...
        /// <summary>
        /// </summary>
        public GetMessageForwardingInfo forwarding { get; set; }
        ...
        ///     Required
        /// </summary>
        public MessageStoreCallerInfoResponseTo[] vmSideRecipients { get; set; }
    }
}