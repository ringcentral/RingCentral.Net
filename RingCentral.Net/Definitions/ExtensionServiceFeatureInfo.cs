namespace RingCentral
{
    public class ExtensionServiceFeatureInfo
    {
        ...
        /// <summary>
        ///     Reason for limitation of a particular service feature. Returned only if the enabled parameter value is 'False', see
        ///     Service Feature Limitations and Reasons. When retrieving service features for an extension, the reasons for the
        ///     limitations, if any, are returned in response
        /// </summary>
