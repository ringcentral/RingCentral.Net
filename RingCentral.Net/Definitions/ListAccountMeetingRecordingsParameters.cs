namespace RingCentral
{
    ...
    public class ListAccountMeetingRecordingsParameters
    {
        ...
        /// <summary>
        ///     Recordings of meetings in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format started after the time
        ///     specified will be returned, for example *2016-03-10T18:07:52.534Z*. Either `meetingId` or
        ///     `meetingStartTime`/`meetingEndTime` can be specified
        /// </summary>
        public string meetingStartTimeFrom { get; set; }

        /// <summary>
        ///     Recordings of meetings in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format started before the time
        ///     specified will be returned, for example *2016-03-10T18:07:52.534Z*. The default value is current time. Either
