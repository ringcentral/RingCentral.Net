namespace RingCentral
{
    public class InboundFaxesInfo
    {
        ...
        /// <summary>
        ///     List of recipient email addresses for inbound fax notifications. Returned if specified, in both modes
        ///     (advanced/basic). Applied in advanced mode only
        /// </summary>
        public string[] advancedEmailAddresses { get; set; }

        /// <summary>
        ///     List of recipient phone numbers for inbound fax notifications. Returned if specified, in both modes
        ///     (advanced/basic). Applied in advanced mode only
        /// </summary>
