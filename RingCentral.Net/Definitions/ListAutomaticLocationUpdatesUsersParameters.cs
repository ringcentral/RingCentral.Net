namespace RingCentral
{
    ...
    public class ListAutomaticLocationUpdatesUsersParameters
    {
        ...
        /// <summary>
        ///     Filters entries containing the specified substring in user name, extension or department. The characters range is
        ///     0-64; not case-sensitive. If empty then the filter is ignored
        /// </summary>
        public string searchString { get; set; }

        /// <summary>
        ///     Department name to filter the users. The value range is 0-64; not case-sensitive. If not specified then the
        ///     parameter is ignored. Multiple values are supported
        /// </summary>
        public string department { get; set; }

        /// <summary>
        ///     Internal identifier of a site. To filter users of Main Site (Company) `main-site` must be specified. Supported only
        ///     If Multi-Site feature is enabled for the account. Multiple values are supported
        /// </summary>
